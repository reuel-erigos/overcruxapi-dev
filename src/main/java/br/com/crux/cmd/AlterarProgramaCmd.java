...
public class AlterarProgramaCmd {
	...
	@Autowired private AlterarListaContasCentrosCustoProgramaCmd alterarListaContasCentrosCustoCmd;
	...
	public void alterar(ProgramaTO to) {
		...
		alterarListaContasCentrosCustoCmd.alterarAll(to.getContasCentrosCusto(), programa);
