...
public class PasseEstudantilBeneficiarioDTO {
	...
	public PasseEstudantilBeneficiarioDTO(Object[] colunas) {
		...
		this.escola                          = (colunas[30] != null) ? (String) colunas[30] : "";
	...
	public void setObservacaoDeclaracaoPasse(String observacaoDeclaracaoMatricula) {
		this.observacaoDeclaracaoPasse = observacaoDeclaracaoMatricula;
	}


	public String getDataDeclaracaoPasse() {
