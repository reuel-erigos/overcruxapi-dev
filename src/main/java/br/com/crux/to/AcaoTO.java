...
public class AcaoTO {
	...
	private List<AnexosAcaoPlanejamentoTO> anexos = new ArrayList<AnexosAcaoPlanejamentoTO>();
	...
	private GrupoAcoesSimlesTO grupoAcao;
	...
	public List<AnexosAcaoPlanejamentoTO> getAnexos() {
		return anexos;
	}
	...
	public GrupoAcoesSimlesTO getGrupoAcao() {
		return grupoAcao;
	}

	public void setGrupoAcao(GrupoAcoesSimlesTO grupoAcao) {
