...
public class PedidoService {
	...
	@GetMapping
	public List<PedidoTO> getAll() {
		//		return getCmd.getAll();
		return Collections.emptyList();
	}

	@GetMapping("/{id}")
	public PedidoTO getById(@PathVariable Long id) {
		// return getCmd.getTOById(id);
		return null;
	}

	@PostMapping
	public void cadastrar(@RequestBody PedidoTO to) {
		//		cadastrarCmd.cadastrar(to);
	}

	@PutMapping
	public void alterar(@RequestBody PedidoTO to) {
