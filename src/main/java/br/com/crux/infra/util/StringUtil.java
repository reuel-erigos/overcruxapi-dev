...
public class StringUtil {
	...
	/**
	 * Recebe um valor e retorna o valor formatado.
	 * @param value
	 * @param pattern exemplo: ##-###.###
	 * @return
	 */
	...
	/**
	 * @author wilson.souza Acrescenta caracteres a esquerda
	 * @param valueToPad
	 * @param filler
	 * @param size
	 * @return
	...
	/**
	 * @author wilson.souza Acrescenta caracteres a direita
	 * @param valueToPad
	 * @param filler
	 * @param size
	 * @return
	...
	/**
	 * @author wilson.souza Retira os acentos e caracteres especiais.
	 *
	 * @param string
	...
	/**
	 * @author wilson.souza Verifica se o parâmetro está vazio.
	 * @param valor
	 * @return
	 */
	...
	/**
	 * Retorna a string com a primeira letra em maiuscula. As preposições entres as palavras ficarão em minuscula.
	 * 
	 * @author wilson.souza
	 * @param valor
	 * @return String
	...
	/**
	 * Converte a string informada em um array de byte. Ideal para salvar textos longos em campos do tipo BLOB do banco de dados.
	 * 
	 * @param texto
	 * @return
	 */
	...
	/**
	 * Converte o array de bytes informado em um String. Ideal para recuperar textos longos salvos no banco de dados do tipo BLOB.
	 * 
	 * @param array
	 * @return
	 */
