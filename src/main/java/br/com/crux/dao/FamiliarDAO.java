...
public class FamiliarDAO extends BaseDao{
	...
	public List<ComboFamiliarDTO> getAllComboByInstituicao(Long idInstituicao) {
		...
		sql.append("        'RESPONSÁVEL:' || pf.nm_pessoa_fisica || ' - BENEFICIÁRIO: ' || pa.nm_pessoa_fisica       ");
		...
		sql.append(" inner join pessoas_fisicas pa on pa.id_pessoa_fisica = a.id_pessoa_fisica                        ");
