...
@Component
public class DeclaracaoBeneficiarioDao extends BaseDao{
	
	
	public List<DeclaracaoBeneficiarioDTO> get(List<Integer> listaIdsPessoaFisica) {
		...
		List<DeclaracaoBeneficiarioDTO> retorno = new ArrayList<DeclaracaoBeneficiarioDTO>();
		values.stream().forEach( colunas -> retorno.add(new DeclaracaoBeneficiarioDTO(colunas)));
